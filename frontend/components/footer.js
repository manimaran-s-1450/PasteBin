    ...
    <footer class="footer">
      <div class="container footer-content">
        ...
        <div class="footer-col">
          ...
          <a href="https://github.com/manimaran-s-1450/PasteBin" target="_blank" rel="noopener noreferrer" class="footer-link">
            <span>GitHub</span>
        ...
        <div class="footer-col">
          ...
          <div class="social-icons">
            <a href="https://github.com/manimaran-s-1450/PasteBin" target="_blank" rel="noopener noreferrer" aria-label="GitHub" class="social-btn">
