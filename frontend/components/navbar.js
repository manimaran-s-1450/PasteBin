/**
 * Navbar Component Injector for all pages (index.html, create.html, view.html, edit.html, history.html, docs.html, about.html, login.html, signup.html)
 * Guarantees a unified mobile hamburger menu drawer & backdrop on every single page.
 */
export function renderNavbar() {
  ...
  if (container) {
    ...
    // For pages with static header, dynamically append drawer & backdrop if missing
    if (!document.getElementById('nav-drawer')) {
      const drawerDiv = document.createElement('div');
      drawerDiv.id = 'dynamic-drawer-wrapper';
      drawerDiv.innerHTML = `
        <div id="nav-drawer-backdrop" class="nav-drawer-backdrop" aria-hidden="true"></div>
        <aside id="nav-drawer" class="nav-drawer" aria-label="Mobile Navigation">
          <div class="nav-drawer-header">
